...
export default function SoundToggle() {
  ...
  return (
    <button
      onClick={toggle}
      className="fixed bottom-5 right-5 md:bottom-6 md:right-6 z-50 w-10 h-10 md:w-11 md:h-11 rounded-full bg-surface-dark/80 backdrop-blur-md border border-white/10 flex items-center justify-center text-white/70 hover:text-white hover:border-white/25 transition-all duration-300 group"
