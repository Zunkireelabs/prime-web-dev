                ...
                <div className="col-span-9 grid grid-cols-4" style={{ gap: "32px" }}>
                  ...
                  <div>
                    ...
                    <ul className="space-y-0">
                      {spaces.map((s) => (
                        <li key={s}>
                          <a href={`/products?space=${encodeURIComponent(s)}`} className="group flex items-center gap-1.5 text-[0.95rem] leading-relaxed text-ink-on-dark-light hover:text-accent-light transition-colors duration-300" style={{ padding: "14px 0" }}>
                            <span>{s}</span>
