...
export const browseData: BrowseData = {
  Finishes: [
    { name: "Matt", image: "/images/browse/finish-matt.webp" },
    { name: "Glossy", image: "/images/browse/finish-glossy.webp" },
    { name: "High Gloss", image: "/images/browse/finish-high-gloss.webp" },
    { name: "Polished", image: "/images/browse/finish-polished.webp" },
    { name: "Satin", image: "/images/browse/finish-satin.webp" },
    { name: "Rustic", image: "/images/browse/finish-rustic.webp" },
    { name: "Carving", image: "/images/browse/finish-carving.webp" },
  ],
  Sizes: [
    { name: "300×600 mm", image: "/images/browse/size-300x600.webp" },
    { name: "400×400 mm", image: "/images/browse/size-400x400.webp" },
    { name: "600×600 mm", image: "/images/browse/size-600x600.webp" },
    { name: "600×1200 mm", image: "/images/browse/size-600x1200.webp" },
  ],
  Colors: [
    { name: "White", image: "/images/browse/color-white.webp" },
    { name: "Beige", image: "/images/browse/color-beige.webp" },
    { name: "Grey", image: "/images/browse/color-grey.webp" },
    { name: "Brown", image: "/images/browse/color-brown.webp" },
    { name: "Blue", image: "/images/browse/color-blue.webp" },
    { name: "Gold", image: "/images/browse/color-gold.webp" },
  ],
  Types: [
    { name: "Ceramic", image: "/images/browse/type-ceramic.webp" },
    { name: "Vitrified", image: "/images/browse/type-vitrified.webp" },
    { name: "Glazed Vitrified", image: "/images/browse/type-glazed.webp" },
    { name: "Wood Look", image: "/images/browse/type-wood.webp" },
    { name: "Stone Look", image: "/images/browse/type-stone.webp" },
    { name: "Art", image: "/images/browse/type-art.webp" },
  ],
};
