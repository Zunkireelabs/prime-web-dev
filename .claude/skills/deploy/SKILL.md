---
name: deploy
description: Deploy Prime Ceramics website to dev. Use when the user says deploy, push live, go live, ship it, or update the site. Runs build checks before deploying.
---
